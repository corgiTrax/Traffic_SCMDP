...
ax1.errorbar(scphi_eps, scphi_arr_mean, yerr=ss.t.ppf(0.95, scphi_dof)*scphi_arr_std, color = 'm', fmt = 'x', ls = 'dotted', label = "SCPHI")
...
ax1.legend(handles, labels, loc = 'upper right', framealpha = 0.5)
#plt.ylim((-0.5, None))
plt.xlabel("Episode")
plt.ylabel("% of Capacity Arrivied")
plt.show()
